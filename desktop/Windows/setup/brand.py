...
# --- палитра ---------------------------------------------------------------
# Строго чёрно-белая, как и весь интерфейс. Оба перехода едва заметны и нужны
# только чтобы крупные плоскости не выглядели мёртвой заливкой.
BG_TOP = (26, 26, 26)         # #1A1A1A
BG_BOTTOM = (0, 0, 0)         # #000000
MARK_TOP = (255, 255, 255)    # #FFFFFF
MARK_BOTTOM = (196, 196, 196)  # #C4C4C4
